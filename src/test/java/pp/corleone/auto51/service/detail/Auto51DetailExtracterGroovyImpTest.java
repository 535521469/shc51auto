...
public class Auto51DetailExtracterGroovyImpTest {
	...
	public static void beforeClass() {
		try {
			doc = Jsoup.connect("http://www.51auto.com/buycar/1890954.html")
					.get();
		} catch (IOException e) {
	...
	public void testfillPrice() {
		assertEquals("29.00万", auto51CarInfo.getPrice());
	}
	...
	public void testfillManufacturerAndBrand() {
		assertEquals("沃尔沃S40", auto51CarInfo.getBrand());
		assertEquals("长安沃尔沃", auto51CarInfo.getManufacturer());
	}
